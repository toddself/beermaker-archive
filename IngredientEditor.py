...
class IngredientEditor(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.topLevelCtrl = wx.ListCtrl(self.panel_1, -1, style=wx.LC_REPORT|wx.LC_SINGLE_SEL|wx.SUNKEN_BORDER)
        self.middleLevelCtrl = wx.ListCtrl(self.panel_1, -1, style=wx.LC_REPORT|wx.LC_SINGLE_SEL|wx.SUNKEN_BORDER)
        self.bottomLevelCtrl = wx.ListCtrl(self.panel_1, -1, style=wx.LC_REPORT|wx.LC_SINGLE_SEL|wx.SUNKEN_BORDER)
        ...
        self.label_9_copy_4 = wx.StaticText(self.panel_4, -1, "Diastic Power:")
        self.disasticPowerCtrl = wx.TextCtrl(self.panel_4, -1, "")
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(self.disasticPowerCtrl, 1, wx.ALL|wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    ...
    def NewIngredient(self, event): # wxGlade: IngredientEditor.<event_handler>
        print "Event handler `NewIngredient' not implemented!"
        event.Skip()
